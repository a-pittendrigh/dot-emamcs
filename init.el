...
(custom-set-variables
 ...
 '(package-selected-packages
   '(doom-themes which-key-posframe auto-complete solarized-theme magit tagedit rainbow-delimiters projectile smex ido-completing-read+ cider clojure-mode-extra-font-locking clojure-mode paredit exec-path-from-shell)))
